...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, BK_LED_Pin | DB7_Pin | DB6_Pin | DB5_Pin | DB4_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LCD_EN_Pin | LCD_RS_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pin : BK_LED_Pin */
  GPIO_InitStruct.Pin = BK_LED_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
